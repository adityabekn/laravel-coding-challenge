...
<html lang="en">
    ...
    <body class="h-screen bg-gray-100">
        <div class="flex flex-col items-center justify-center">
            <span class="my-5 text-3xl">Form Edit User</span>
            <div class="lg:w-1/4 md:w-1/3 sm:w-full">

                <form action="{{ route('edit.store', ['id' => $profile->id]) }}" method="post">
                    @csrf
                    @if($errors->has('name'))
                    ...
                    <div class="flex justify-between my-2">
                        ...
                        <x-forms.input value="{{ $profile->name }}"></x-forms.input>
                    </div>
                    ...
                    <div class="flex justify-between my-2">
                        ...
                        <x-forms.inputpassword></x-forms.inputpassword>
                    </div>
